#!/usr/bin/env python3
"""
API Flask para servir dados históricos da B3
"""
...
if __name__ == '__main__':
    print("🚀 Iniciando API de dados históricos B3")
    print(f"📂 Banco de dados: {DB_PATH}")
    print(f"🌐 Servidor: http://localhost:5000")
    print("\n📋 Endpoints disponíveis:")
    print("  GET /api/health - Status da API")
    print("  GET /api/stats - Estatísticas do banco")
    print("  GET /api/stocks - Listar todas as ações")
    print("  GET /api/stock/<symbol> - Dados de uma ação")
    print("  GET /api/stock/<symbol>/latest - Última cotação")
    print("  GET /api/stock/<symbol>/period?period=1y - Dados por período")
    print("\n✨ API pronta para uso!\n")
